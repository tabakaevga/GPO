...
namespace UnitTests.Model
{
    ...
    internal class TriangleTest
    {
        ...
        [TestCase(5, -2, 6, ExpectedException = typeof(ArgumentOutOfRangeException),
            TestName = "Тестирование Area при сторонах = 5, -1, 6.")]
        [TestCase(-5, 2, 6, ExpectedException = typeof(ArgumentOutOfRangeException),
            TestName = "Тестирование Area при сторонах = -5, 2, 6.")]
        [TestCase(5, 2, -6, ExpectedException = typeof(ArgumentOutOfRangeException),
            TestName = "Тестирование Area при сторонах = 5, 2, -6.")]
        [TestCase(-5, -2, -6, ExpectedException = typeof(ArgumentOutOfRangeException),
            TestName = "Тестирование Area при сторонах = -5, -2, -6.")]
        ...
        [TestCase("asdf", "asdf", "asdf", ExpectedException = typeof(ArgumentException),
            TestName = "Тестирование Area при трех сторонах не выраженных вещественным числом.")]
        ...
        [TestCase(5, -2, 6, ExpectedException = typeof(ArgumentOutOfRangeException),
            TestName = "Тестирование Length при сторонах = 5, -1, 6.")]
        [TestCase(-5, 2, 6, ExpectedException = typeof(ArgumentOutOfRangeException),
            TestName = "Тестирование Length при сторонах = -5, 2, 6.")]
        [TestCase(5, 2, -6, ExpectedException = typeof(ArgumentOutOfRangeException),
            TestName = "Тестирование Length при сторонах = 5, 2, -6.")]
        [TestCase(-5, -2, -6, ExpectedException = typeof(ArgumentOutOfRangeException),
            TestName = "Тестирование Length при сторонах = -5, -2, -6.")]
        ...
        [TestCase("asdf", 5, 6, ExpectedException = typeof(ArgumentException),
            TestName = "Тестирование Length при стороне не выраженной вещественным числом.")]
        [TestCase("asdf", "asdf", "asdf", ExpectedException = typeof(ArgumentException),
            TestName = "Тестирование Length при трех сторонах не выраженных вещественным числом.")]
        [TestCase(double.NaN, 5, 6, ExpectedException = typeof(NotFiniteNumberException),
